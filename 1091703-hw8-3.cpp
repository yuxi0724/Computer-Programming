   ...
   if( size != 0 && multiplier.size != 0 )
   {
       if (size != 0 && multiplier.size != 0)
       {
           ...
           while (buf != multiplier.size)
           {
               for (int i = 0; i < size; i++)
               {
                   buffer.terms[i].expon = terms[i].expon + multiplier.terms[buf].expon;
                   buffer.terms[i].coef = terms[i].coef * multiplier.terms[buf].coef;
               }
